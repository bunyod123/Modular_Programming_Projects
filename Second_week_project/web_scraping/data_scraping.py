...
async def scraper(max_page=50):
    async with async_playwright() as p:
        try:
            ...
            path = Path(r"C:\Users\bunyo\onedrive\desktop\AI_Course\ModularProgramProjects\Second_week_project\data\scrapped_data")
            full_path = os.path.join(path, "earthquake.csv")
